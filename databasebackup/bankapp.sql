...
CREATE TABLE `clientaccount` (
  ...
  UNIQUE KEY `fullaccountnumber` (`branchid`,`clientaccountid`),
  KEY `branchid_2` (`branchid`),
  KEY `accounttypeid` (`accounttypeid`),
  KEY `clientid` (`clientid`),
  CONSTRAINT `clientaccount_ibfk_1` FOREIGN KEY (`branchid`) REFERENCES `branch` (`branchid`),
  CONSTRAINT `clientaccount_ibfk_2` FOREIGN KEY (`accounttypeid`) REFERENCES `accounttype` (`accounttypeid`),
...
INSERT INTO `employee` VALUES (20000001,10000005,10001,10,120000,'Carla','Suarez',10002,1),(20000002,10000006,10002,10,110000,'Daniela','Hantuchova',10002,1),(20000003,10000007,10003,10,110000,'Flavia','Pennetta',10002,1),(20000004,10000008,10004,10,100000,'Arantxa','Parra',10003,1),(20000005,10000009,10001,15,80000,'Alisa','Kleybanova',10003,1),(20000006,10000010,10002,15,75000,'Kateryna','Bondarenko',10001,1),(20000007,10000011,10003,15,70000,'Jie','Zheng',10001,1),(20000008,10000012,10004,15,75000,'Francesca','Schiavone',10001,1),(20000009,10000013,10001,20,55000,'Caroline','Wozniacki',10004,1),(20000010,10000014,10002,20,58000,'Dominika','Cibulkova',10001,1),(20000011,10000015,10003,20,60000,'Sybille','Bammer',10001,1),(20000012,10000016,10004,20,65000,'Yanina','Wickmayer',10001,1),(20000013,10000017,10001,30,30000,'Olga','Govortsova',10001,1),(20000014,10000018,10001,30,32000,'Jo-Wilfried','Tsonga',10001,1),(20000015,10000019,10001,30,35000,'John','Isner',10001,1),(20000016,10000020,10001,30,30000,'Ernests','Gulbis',10001,1),(20000017,10000021,10001,20,45000,'Albert','Montanes',10001,1),(20000018,10000022,10001,30,35000,'Tommy','Robredo',10001,1),(20000019,10000023,10002,30,30000,'Sam','Querrey',10001,1),(20000020,10000024,10002,30,32000,'Eduardo','Schwank',10001,1),(20000021,10000025,10002,30,35000,'Brian','Blanchette',10001,1),(20000022,10000026,10002,30,30000,'Patsy','Keays',10001,1),(20000023,10000027,10002,30,32000,'Philipp','Petzschner',10001,1),(20000024,10000028,10002,30,35000,'Richard','Gasquet',10001,1),(20000025,10000029,10003,30,30000,'Gael','Monfils',10004,1),(20000026,10000030,10003,30,32000,'Ivan','Ljubicic',10004,1),(20000027,10000031,10003,30,35000,'Sabine','Lisicki',10004,1),(20000028,10000032,10003,30,30000,'Maria','Sharapova',10001,1),(20000029,10000033,10003,30,32000,'Venus','Williams',10001,1),(20000030,10000034,10003,30,35000,'Marcos','Baghdatis',10001,1),(20000031,10000035,10004,30,30000,'Feliciano','Lopez',15,1),(20000032,10000036,10004,30,32000,'Mikhail','Youzhny',10,1),(20000033,10000037,10004,30,35000,'Fernando','Verdasco',15,1),(20000034,10000038,10004,30,30000,'Guillermo','Garcia-Lopez',15,1),(20000035,10000039,10004,30,32000,'Rafael','Nadal',15,1),(20000036,10000040,10004,30,35000,'Andy','Roddick',10,1);
...
INSERT INTO `employeeworkhistory` VALUES (20000014,10001,'2008-01-01','2008-12-31',30,'30000.00'),(20000014,10001,'2009-01-01','0000-00-00',20,'40000.00'),(20000014,10001,'2010-08-05','0000-00-00',15,'60000.00'),(20000017,10001,'2009-01-01','2009-05-31',30,'25000.00'),(20000017,10001,'2009-06-01','2009-12-31',30,'30000.00'),(20000017,10001,'2010-01-01','0000-00-00',20,'45000.00');
...
-- Dump completed on 2010-08-05 13:03:01
