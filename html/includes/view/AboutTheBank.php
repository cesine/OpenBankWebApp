			...
			<table width="188" border="0" cellspacing="0" cellpadding="0">
				...
				<tbody>
					<tr valign="top">
						<td width="13"><img src="images/greyarrow.gif" alt="image" width="5"
							height="5" hspace="4" vspace="6" border="0"></td>
						<td><a href="index.php?&content=Insurance"
							class="boldnav">Insurance</a> <br>
						<a href="index.php?&content=LifeInsurance"
...
elseif($content=="BusinessChequing"){
	...
	<tr valign='top'>
	<td rowspan='2'><br></td>
	<td class='headline2'>Chequing Account for the Real Business World<br><br></td>
	</tr>
