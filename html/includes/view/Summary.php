...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			...
			<TR class="bgcoloroption1">
				...
				<TD class=fieldTitleRightC width="19%"><a class="helpLinkC"
					href="javascript:surfToMainHelp('Balance_ENG.htm')">Balance</a></td>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
					...
					<TR class=bgcoloroption1>
						<TD class=fieldTitleLeftC><a class="helpLinkC">Total </a></TD>
	...
	<tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
			<TR class="bgcoloroptionA">
				<TD colSpan=5><FONT class=fieldTitleLeftC><a class="helpLinkC">Personal
				Accounts</a></FONT></TD>
			</TR>

			<TR class="bgcoloroptionB">
				<TD class=fieldTitleLeftC colSpan=2><a class="helpLinkC">Assets</a></td>
				<TD class="bgcoloroption2">&nbsp;</td>
				<TD class=fieldTitleLeftC colSpan=2><a class="helpLinkC">Liabilities</a></td>
			</tr>
			...
			<TR class="bgcoloroption1">
				...
				<TD width="2%" class="bgcoloroption2">&nbsp;</TD>
				<TD class=fieldTitleLeftC width="30%"><a class="helpLinkC">Account
				Name </a></td>
				<TD class=fieldTitleRightC width="19%"><a class="helpLinkC">Balance</a>
				</td>
			</tr>
			...
			<tr>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="2">
					<tr class='bgcoloroption2'>
						...
						<TD class="acctC" vAlign=top align=left width="30%"><a
							class='accountLinkB'
							href='/portal/index.jsp?pageID=financial_services_banking&reqOption=AccountDetails&accountNum=SAV;PC;SAV;PC;CAD;5.07000000000000028421709430404007434844970703125;4066729351047152490@-3336690819295176166'><?php $clientAccount->getAccountTypeName()?></a></td>
